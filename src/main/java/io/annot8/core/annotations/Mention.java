...
/**
 * This interface is identical to the {@link Span} interface, but is
 ...
 * other types of Span that might be used for, as an example, grammatical properties.
 */
public interface Mention extends Span {
